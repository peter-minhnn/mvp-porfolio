...
2. **Read local agent instructions**: `AGENTS.md`, `CLAUDE.md`, `.agents/skills`. Project-authored instructions and rules OVERRIDE generated references when they conflict.
